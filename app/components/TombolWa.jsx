...
export const TombolWa = () => {
  ...
  return (
    <>
        ...
        <div onClick={getUrl} className="cursor-pointer p-2 sm:py-3 shadow-xl fixed bottom-36 sm:bottom-16 text-right right-0 backdrop-blur-md rounded-l-full bg-gradient-to-r from-green-400/80 to-green-700/80">
