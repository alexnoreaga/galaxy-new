...
export const TombolBalasCepat = ({setBukaModalBalasCepat}) => {
  return (
    <>  
    <div  onClick={()=>setBukaModalBalasCepat(true)} className="cursor-pointer p-2 sm:py-3 shadow-xl fixed bottom-44 text-right right-0 backdrop-blur-md rounded-l-full bg-gradient-to-r from-sky-400/80 to-sky-700/80">
