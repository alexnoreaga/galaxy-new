  ...
  return (
    <button
      ...
      className={variant === 'plain'
        ? `w-9 h-9 -mr-2 flex items-center justify-center rounded-full transition-all active:scale-95 ${isWished ? 'text-rose-500' : 'text-gray-500 hover:text-rose-400'}`
    ...
    >
      {isWished ? (
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className={variant === 'plain' ? 'w-6 h-6' : 'w-4 h-4'}>
        ...
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.8} stroke="currentColor" className={variant === 'plain' ? 'w-6 h-6' : 'w-4 h-4'}>
