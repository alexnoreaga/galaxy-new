...
export function Layout({cart, children = null, footer, header, isLoggedIn,footerSatu}) {
  ...
  <div className='p-5 mx-auto sm:max-w-screen-sm md:max-w-screen-md lg:max-w-screen-lg xl:max-w-screen-xl'>
    <h1 className='md:mb-2 mb-1 text-left text-md md:text-xl lg:text-4xl text-white'>Kunjungi Toko Kami</h1>
    ...
    >
    <div className="flex flex-row items-center bg-white/30 backdrop-blur-sm  w-44 h-12 rounded-full mt-3">
