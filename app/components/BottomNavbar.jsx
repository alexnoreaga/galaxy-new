    ...
    <>
      <div className="sm:block md:hidden fixed bottom-0 left-0 z-50 w-full bg-white/80 backdrop-blur-lg border-t border-gray-100/50 shadow-2xl">
        <div className="grid grid-cols-5 max-w-lg mx-auto px-2">
          ...
          {/* Promo */}
          <Link className="m-auto" prefetch="intent" to="/promo">
            <button type="button" className="inline-flex flex-col items-center justify-center py-3 px-2 group relative">
              <div className="absolute inset-0 rounded-xl bg-gradient-to-br from-orange-50 to-rose-50 opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6 mb-1 text-gray-600 group-hover:text-orange-600 transition-colors duration-300 relative z-10 group-hover:scale-110 transform transition-transform">
                <path strokeLinecap="round" strokeLinejoin="round" d="M9 14.25l6-6m4.5-3.493V21.75l-3.75-1.5-3.75 1.5-3.75-1.5-3.75 1.5V4.757c0-1.108.806-2.057 1.907-2.185a48.507 48.507 0 0111.186 0c1.1.128 1.907 1.077 1.907 2.185zM9.75 9h.008v.008H9.75V9zm.375 0a.375.375 0 11-.75 0 .375.375 0 01.75 0zm4.125 4.5h.008v.008h-.008V13.5zm.375 0a.375.375 0 11-.75 0 .375.375 0 01.75 0z" />
              </svg>
              <p className="text-[10px] font-semibold text-gray-600 group-hover:text-orange-600 transition-colors duration-300 relative z-10">Promo</p>
            </button>
          </Link>

          {/* Location */}
          <Link className="m-auto" prefetch="intent" to="/pages/contact">
            <button type="button" className="inline-flex flex-col items-center justify-center py-3 px-2 group relative">
              <div className="absolute inset-0 rounded-xl bg-gradient-to-br from-green-50 to-emerald-50 opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6 mb-1 text-gray-600 group-hover:text-green-600 transition-colors duration-300 relative z-10 group-hover:scale-110 transform transition-transform">
                <path strokeLinecap="round" strokeLinejoin="round" d="M15 10.5a3 3 0 11-6 0 3 3 0 016 0z" />
                <path strokeLinecap="round" strokeLinejoin="round" d="M19.5 10.5c0 7.142-7.5 11.25-7.5 11.25S4.5 17.642 4.5 10.5a7.5 7.5 0 1115 0z" />
              </svg>
              <p className="text-[10px] font-semibold text-gray-600 group-hover:text-green-600 transition-colors duration-300 relative z-10">Alamat</p>
            </button>
          </Link>
        </div>
      </div>
