...
<div className="sm:block md:hidden  fixed bottom-0 left-0 z-50 w-full h-16 backdrop-blur-md bg-white border-t border-gray-100 dark:bg-gray-700 dark:border-gray-600">
    <div className="grid h-full max-w-lg grid-cols-5 mx-auto font-medium">
            ...
            <button type="button" className="inline-flex flex-col items-center justify-center  dark:hover:bg-gray-800 group">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6 mb-1 text-gray-800 dark:text-gray-400 group-hover:text-red-600 dark:group-hover:text-red-500">
                    <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 12l8.954-8.955c.44-.439 1.152-.439 1.591 0L21.75 12M4.5 9.75v10.125c0 .621.504 1.125 1.125 1.125H9.75v-4.875c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125V21h4.125c.621 0 1.125-.504 1.125-1.125V9.75M8.25 21h8.25" />
                </svg>

                <p className="text-xs text-gray-800 dark:text-gray-400 group-hover:text-red-600 dark:group-hover:text-red-500">Home</p>
            </button>
            </Link>
        ...
        <button type="button" className="inline-flex flex-col items-center justify-center  dark:hover:bg-gray-800 group">
                ...
                <p className="text-xs text-gray-800 dark:text-gray-400 group-hover:text-red-600 dark:group-hover:text-red-500">Cari</p>
            </button>
        </Link>
        ...
        <Link
                ...
                <button type="button" className="inline-flex flex-col items-center justify-center  dark:hover:bg-gray-800 group">
                    ...
                    <p className="text-xs text-gray-800 dark:text-gray-400 group-hover:text-red-600 dark:group-hover:text-red-500">Kategori</p>
                </button>
        </Link>
        ...
        <Link
            ...
            <button type="button" className="inline-flex flex-col items-center justify-center dark:hover:bg-gray-800 group">
                ...
                <p className="text-xs text-gray-800 dark:text-gray-400 group-hover:text-red-600 dark:group-hover:text-red-500">Alamat</p>
            </button>
            </Link>
    </div>
</div>
