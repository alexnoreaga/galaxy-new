...
export const BottomNavbar = () => {
  return (
    <>
<div className="sm:block md:hidden fixed bottom-0 left-0 z-50 w-full h-16 backdrop-blur-md bg-white/10  border-gray-100 dark:bg-gray-700 dark:border-gray-600">
