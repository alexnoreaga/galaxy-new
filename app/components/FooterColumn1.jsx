  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      <div className="flex flex-col gap-2">
        ...
        <a
          href="https://api.whatsapp.com/send?phone=6282122335511&text=Hi%20admin%20Galaxy.co.id%20saya%20berminat%20produk"
          target="_blank"
          rel="noreferrer"
          className="flex items-center gap-2 text-gray-400 hover:text-white transition-colors no-underline group"
        >
          <FaWhatsapp className="w-4 h-4 text-green-500" />
          <span className="text-sm group-hover:text-white">0821-2233-5511</span>
        </a>
